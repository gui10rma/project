...
export default function FormContato({ valores, onSubmit }: Props) {
  ...
  return (
    <View>
      ...
      <TextInput placeholder="Telefone" value={telefone} onChan-geText={setTelefone} style={global.input} />
      <TextInput placeholder="Endereço" value={endereco} onChan-geText={setEndereco} style={global.input} />
